    ...
    <body class="hold-transition skin-blue sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <div class="row" style="padding-top: 20px;">
                    <div class="col-sm-10 col-sm-offset-1">
                        <form class="form-horizontal" id="formCrearEstado">
                            <fieldset>
                                <legend class="font-color">Creación de estados</legend>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="descripcionEstado" name="descripcionEstado" placeholder="Descripción del estado" class="form-control" required></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label"></label>
                                    <div class="col-md-8">
                                        <button type="button" id="btn-confirm" name="btn-confirm" class="btn btn-primary">Crear estado</button>
                    ...
                    <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="modal-estado-created">
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                <div class="modal-header active">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                ...
                                <div class="modal-body">
                                    <p id="modal-content-estado-created"></p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" id="modal-btn-estado-created-ok">Aceptar</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            $('#modal-confirm').on('shown.bs.modal', function (e) {
                ...
                document.getElementById("modal-content-create").innerHTML = "Confirma la creación del estado <b>" + nombreEstadoModal + "</b>";
            });
        </script>
        <script>
            $("#btn-confirm").on("click", function () {
                ...
                if (nombreEstado === "" || descripcionEstado === "") {
            ...
            $("#modal-btn-estado-created-ok").on("click", function () {
                $("#modal-estado-created").modal('hide');
        ...
        <script>
            function crearEstado() {
                ...
                if (nombreEstado === "" || descripcionEstado === "") {
                    ...
                    data.append("nombreEstado", nombreEstado);
                    data.append("descripcionEstado", descripcionEstado);
                    $.ajax({
                        url: url,
                        data: data,
                        cache: false,
                        ...
                        success: function (resp) {
                            $("#formCrearEstado")[0].reset();
                            if (resp === "Creado") {
                                document.getElementById("modal-content-estado-created").innerHTML = "El estado <b>" + nombreEstado + "</b> ha sido creado correctamente.";
                                $("#modal-estado-created").modal('show');
                            } else if (resp === "Error al crear") {
                                document.getElementById("modal-content-error").innerHTML = "Error al crear el estado <b>" + nombreEstado + "</b>.<br>Intente nuevamente.";
                                $("#modal-form-error").modal('show');
                            } else if (resp === "Nombre estado existe") {
                                document.getElementById("modal-content-error").innerHTML = "Error al crear el estado <b>" + nombreEstado + "</b>.<br>\n\
