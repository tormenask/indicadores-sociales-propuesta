                ...
                <div class="row">
                            ...
                            <form class="form-horizontal" id="formEditarUsuario">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="contrasenaAterior">Anterior contraseña</label>  
                                        <div class="col-md-6">
                                            <input id="contrasenaAnterior" name="contrasenaAnterior" type=password placeholder="Anterior contraseña" class="form-control input-md" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="contrasenaNueva">Contraseña nueva</label>  
                                        <div class="col-md-6">
                                            <input id="contrasenaNueva" name="contrasenaNueva" type=password placeholder="Contraseña nueva" class="form-control input-md" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="contrasenaNuevaR">Repita la contraseña</label>  
                                        <div class="col-md-6">
                                            <input id="contrasenaNuevaR" name="contrasenaNuevaR" type=password placeholder="Repita la contraseña" class="form-control input-md" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                    ...
                    <script>
                        $("#btn-confirm").on("click", function () {
                            ...
                            var contrasenaNuevaR = $("#contrasenaNuevaR").val();
                            if (contrasenaAnterior === "" || contrasenaNueva === "" || contrasenaNuevaR === "" || contrasenaNuevaR !== contrasenaNueva || contrasenaNuevaR === null || contrasenaAnterior === null || contrasenaNueva === null) {
                                $("#modal-form-error").modal('show');
                            } else if (contrasenaNueva === contrasenaAnterior || contrasenaNuevaR !== contrasenaNueva) {
                    ...
                    <script>
                        function cambiarContrasena() {
                            ...
                            if (contrasenaAnterior === "" || contrasenaNueva === "" || contrasenaNuevaR === "" || contrasenaNuevaR !== contrasenaNueva || contrasenaNuevaR === null || contrasenaAnterior === null || contrasenaNueva === null) {
                                ...
                                data.append("contrasenaAnterior", contrasenaAnterior);
                                data.append("contrasenaNueva", contrasenaNueva);
                                data.append("contrasenaNuevaR", contrasenaNuevaR);
                                $.ajax({
                                    url: url,
                                    data: data,
                                    cache: false,
