...
<html lang="es">
    <head>
      <script async src="https://www.googletagmanager.com/gtag/js?id=UA-120901382-1"></script>
        ...
        <link href="/siscali/views/resources/css/sidebar.css" rel="stylesheet" type="text/css"/>
        <link href="/siscali/views/resources/lib/jquery-ui-themes-1.12.1/themes/smoothness/jquery-ui.css" rel="stylesheet"/>
        ...
        <link href="/siscali/views/resources/lib/jQCloud/jqcloud/jqcloud.css" rel="stylesheet" type="text/css">
        <script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
        <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.min.js"></script>
        <script src="/siscali/views/resources/lib/jquery-number/jquery.number.min.js"></script>
        ...
        <script src="/siscali/views/resources/lib/tableExport/libs/FileSaver/FileSaver.min.js"></script>
        <script src="/siscali/views/resources/lib/tableExport/libs/js-xlsx/xlsx.core.min.js" ></script>
        <script src="/siscali/views/resources/lib/tableExport/libs/jsPDF/jspdf.min.js"></script>
        <script src="/siscali/views/resources/lib/tableExport/libs/jsPDF-AutoTable/jspdf.plugin.autotable.js"></script>
        <script src="/siscali/views/resources/lib/tableExport/libs/html2canvas/html2canvas.min.js"></script>
        <script src="/siscali/views/resources/lib/tableExport/tableExport.min.js"></script>
        <script src="/siscali/views/resources/js/html2canvas.min.js"></script>
