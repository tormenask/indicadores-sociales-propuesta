...
<div class="row">
    <ul class="breadcrumb">
        ...
        <li><a href="/sis/consulta-indicadores/otros-indicadores/exp">Indicadores del Expediente Municipal</a></li>
        <li class="active"><a href="/sis/consulta-indicadores/exp/indicadores">Sobre los indicadores</a></li>
    </ul>
</div>
<div class="row">
    ...
    <div class="col-xs-12 col-sm-8">
        <div id="page-content-wrapper">
            <div id="text-index">
                <h1>Sobre los Indicadores del Expediente Municipal</h1>
                <hr>
                <p>
                        ...
                        <div class="panel panel-green" style="border: solid 1px #388E3C;">
                            ...
                            <div class="panel-body">
                                <ul>
                                    ...
                                    <li>
                                        Sostenibilidad Ambiental y Conservación Ecológica
                                    </li>
                                    <li>
                                        Calidad Ambiental
                                    </li>
