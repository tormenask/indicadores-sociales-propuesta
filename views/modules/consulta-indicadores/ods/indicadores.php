...
<div class="row">
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="/consulta-indicadores/ods/indicadores">Sobre los indicadores ODS para Santiago de Cali</a></li>
    </ul>
</div>
<div class="row">
    ...
    <div class="col-xs-12 col-sm-8">
        <div id="page-content-wrapper">
            <div id="text-index">
                <h1>Sobre los indicadores ODS para Santiago de Cali</h1>
                <hr>
                <h3>Justificación</h3>
                <p>
                ...
                <br>
                <ul>
                    <li>Objetivo 1. Meta: A 2030, Colombia reducirá la pobreza multidimensional al 8,4%.</li>
                    <li>Objetivo 7. Meta: A 2030, Colombia tendrá cobertura universal de energía eléctrica.</li>
                    <li>Objetivo 8. Meta: A 2030, Colombia aumentará la tasa de formalidad laboral a 60%.</li>
                    <li>Objetivo 10. Meta: A 2030, Colombia reducirá el coeficiente de Gini a 0,480.</li>
                    <li>Objetivo 11. Meta: A 2030, Colombia reducirá el déficit cuantitativo de vivienda para hogares urbanos.</li>
                    <li>Objetivo 16. Meta: A 2030, Colombia reducirá la tasa de homicidios a 16,4%.</li>
                </ul>
                <hr>
                <h3>Fases para la definición de los Indicadores para Santiago de Cali</h3>
                <h4>Primera fase: Validación</h4>
                <p>
                ...
                <h4>Segunda fase: Verificación</h4>
                <p>
                ...
                <br>
                <ul>
                    <li>Determinar qué metas y objetivos aplican para Santiago de Cali de acuerdo con las particularidades de su territorio y su entorno.</li>
                    <li>La inclusión de los ODS en el Plan de Desarrollo 2016-2019, “Cali progresa contigo”.</li>
                    <li>La información y datos disponibles para la Ciudad. En algunas metas se utilizan indicadores proxy para su medición.</li>
                    <li>Los objetivos 14 “Vida Submarina” compuesto por 10 metas, y 15 “Vida de Ecosistemas terrestres” compuesta por 12 metas, no aplican para la ciudad de Cali.</li>
                </ul>
                 <h4>Tercera fase: Definición</h4>
                <p>
...
<script>
    ...
    $("#ods-indicadores").addClass("back-item-menu");
</script>